...
def Sillas(ventana, fun, info, idUsuario):
    ...
    global matriz
    matriz = json.loads(fun["sillas"])

    # Lista de leyenda de sillas
    lista = [["L", "Libre", "#8888ff"], ["O", "Ocupado", "#ff8888"], ["S", "Seccion|Reservado", "#888888"], ["R", "Recomendado", "#88ff88"], ["M", "Mis Sillas", "#ffff00"]]
